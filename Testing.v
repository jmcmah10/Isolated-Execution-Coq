...
Compute (NatMap.In 20 (NatMap.add 2 2 (NatMap.add 1 1 (NatMap.empty nat)))).
...
Compute (CacheletMap.add (cachelet_index_value 0 0) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (CacheletMap.empty way_set_cache_value)).
Compute (CacheletMap.add (cachelet_index_value 0 0) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (
  CacheletMap.add (cachelet_index_value 0 3) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (CacheletMap.empty way_set_cache_value))).
Compute (CacheletMap.add (cachelet_index_value 0 0) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (
  CacheletMap.add (cachelet_index_value 0 3) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (
  CacheletMap.add (cachelet_index_value 1 1) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (
  CacheletMap.add (cachelet_index_value 2 0) (valid_bit_tag_and_data dirty_bit 7 (NatMap.empty data)) (CacheletMap.empty way_set_cache_value))))).
